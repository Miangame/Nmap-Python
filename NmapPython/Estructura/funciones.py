...
#Guarda los resultados del escaneo de nmap en un fichero auxiliar, que lee posteriormente 
#y vuelca a una BBDD de MySQL
...
#Realiza un escaneo a partir de una IP concreta, controlada por el patrón regex definido previamente
